...
##sys args - number of datasets being created, current dataset being created, number of spectra to generate
...
while count < num_spectra:
    try:
        ...
        modulation = predict_modulation(
            data_dir=("C:/Users/kxl61517/Documents/xsw-scripts/src/xsw_scripts/fpfpp"),
...
with tf.io.TFRecordWriter(path = '{}recordstest.tfrecords'.format(num_spectra)) as writer:
